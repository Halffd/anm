...
function handleSubtitleFileSelected(files: File[]) {
  if (files.length > 0) {
    emit('subtitle-upload', files[0])
  }
}
</script>
  ...
  <div class="video-controls">
    <div class="progress-bar">
      <input 
        ...
        class="video-slider progress-slider"
      />
    </div>
    ...
    <div class="controls-row">
      <div class="left-controls">
        ...
        >
          ...
          <input 
            ...
            class="video-slider volume-slider"
          />
        </div>
      </div>
      ...
      <div class="right-controls">
        <FileInput
          ...
          @file-selected="handleSubtitleFileSelected"
          class="subtitle-upload-button"
        >
        ...
        <button 
          class="control-button" 
          @click="emit('toggle-captions-panel', !captionsPanelVisible)"
          title="Captions Panel (p)"
        >
        ...
        <button 
          class="control-button" 
          @click="emit('toggle-captions', !captionsVisible)"
